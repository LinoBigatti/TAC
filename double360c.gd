...
# 
# Clockwise double 360 generator
# By Lino
#

#meta:name:Create Clockwise Double 360 Pattern
#meta:description:Creates a clockwise double 360 pattern (TT -> CC -> XX -> SS), starting at the first note type.
